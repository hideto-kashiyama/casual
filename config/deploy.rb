...
set :repo_url, "git@github.com:hideto-kashiyama/casual.git"
set :user,            'deploy'
set :pty,             true
set :use_sudo,        false
...
set :passenger_environment_variables, { :path => '/usr/local/rbenv/versions/2.3.4/lib/ruby/gems/2.3.0/gems/passenger-5.3.1/bin:$PATH' }
