...
class MastersControllerTest < ActionController::TestCase
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post :create, master: { category_id: @master.category_id, e: @master.e, husen: @master.husen, j: @master.j, n: @master.n, product_id: @master.product_id }
    end
  ...
  test "should update master" do
    patch :update, id: @master, master: { category_id: @master.category_id, e: @master.e, husen: @master.husen, j: @master.j, n: @master.n, product_id: @master.product_id }
    assert_redirected_to master_path(assigns(:master))
  end
